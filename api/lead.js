...
const PIXEL_ID = '1494090128389962';
const ACCESS_TOKEN = process.env.META_ACCESS_TOKEN || 'EAAPXLJHD020BPbTwKb2kCfIxmzAaTMYG1mkqsKcsNxpnBEu591yWcnTnsQJ0WZALNYa8BNx252bBrHwqRpSAhvpaMLlZCl5MukzxGbXrLezCeupnytx8vdrE9HHYdEMrSxfViMRZAArqHgSatM8wCJmLuhrGc3Ggn5aJIHmhYHzfsfahXa4suYZCirvOCmIrdgZDZD';        // Vercel env
  ...
  try {
    ...
    const payload = {
      data: [{
        ...
        event_source_url: eventSourceUrl || 'https://iqdiet.vercel.app/',
        user_data: {
